...
bool mbot_interface__msg__person__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mbot_interface.msg._person.Person", full_classname_dest, 33) == 0);
  }
  mbot_interface__msg__Person * ros_message = _ros_message;
  {  // name
...
PyObject * mbot_interface__msg__person__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mbot_interface.msg._person");
