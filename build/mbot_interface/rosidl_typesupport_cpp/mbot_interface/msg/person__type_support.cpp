...
static const _Person_type_support_symbol_names_t _Person_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mbot_interface, msg, Person)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mbot_interface, msg, Person)),
  }
};
...
{
  return &::mbot_interface::msg::rosidl_typesupport_cpp::Person_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mbot_interface, msg, Person)() {
  return get_message_type_support_handle<mbot_interface::msg::Person>();
}
