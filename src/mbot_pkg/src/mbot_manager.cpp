...
class MbotManager: public rclcpp::Node{
  public:
   MbotManager():Node("mbot_manager"){
    publisher_ = this->create_publisher<mbot_interface::msg::Person>("mbot_topic", 10);
    subscriber_ = this->create_subscription<mbot_interface::msg::Person>("mbot_topic", 10,[this](const mbot_interface::msg::Person::SharedPtr msg){this->event_callback(msg);});
